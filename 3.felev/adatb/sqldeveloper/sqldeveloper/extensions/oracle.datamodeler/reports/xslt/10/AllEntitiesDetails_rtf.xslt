...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_ae" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 sps xbrldi xbrli xlink xs xsd xsi">
	...
	<xsl:template match="/">
		...
		<xsl:call-template name="altova:DocumentSection_08C1C9C0">
			<xsl:with-param name="altova:nMaxWidthIn" select="10.13"/>
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel"/>
		</xsl:call-template>
		<xsl:text>}</xsl:text>
	</xsl:template>
	<xsl:template name="altova:DocumentSection_08C1C9C0">
		...
		<xsl:call-template name="altova:Section_08C1C9C0_FooterLeft"/>
		<xsl:text>}</xsl:text>
		<xsl:text>{</xsl:text>
		<xsl:text>\footerr </xsl:text>
		<xsl:call-template name="altova:Section_08C1C9C0_FooterRight"/>
		<xsl:text>}</xsl:text>
					...
					<xsl:for-each select="n1:EntityDetails">
						...
						<xsl:if test="count( n1:RelationshipsCollection )">
							...
							<xsl:variable name="altova:RowStyle38">
								...
								<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
								<xsl:if test="$altova:nColumnWidthTw_13_6 = $altova:nDefaultColumnWidthTw_13">
									<xsl:text>\clftsWidth1</xsl:text>
								</xsl:if>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_Tbl13_Col6_AfterColumn" select="$altova:CurrGridPos_Tbl13_Col5_AfterColumn + $altova:nColumnWidthTw_13_6"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl13_Col6_AfterColumn)"/>
								<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
								<xsl:if test="$altova:nColumnWidthTw_13_7 = $altova:nDefaultColumnWidthTw_13">
									<xsl:text>\clftsWidth1</xsl:text>
								</xsl:if>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_Tbl13_Col7_AfterColumn" select="$altova:CurrGridPos_Tbl13_Col6_AfterColumn + $altova:nColumnWidthTw_13_7"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl13_Col7_AfterColumn)"/>
							</xsl:variable>
							<xsl:if test="$templatetablelevel + 1 = 1">
	...
	<xsl:template name="altova:Section_08C1C9C0_FooterRight">
	...
	<xsl:template name="altova:Section_08C1C9C0_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0981AC18" select="."/>
