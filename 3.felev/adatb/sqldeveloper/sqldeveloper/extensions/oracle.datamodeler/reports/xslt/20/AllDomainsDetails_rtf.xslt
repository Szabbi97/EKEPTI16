...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_ad" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:call-template name="altova:Section_06B6B2A8_FooterLeft"/>
			<xsl:text>}</xsl:text>
			<xsl:text>{</xsl:text>
			<xsl:text>\footerr </xsl:text>
			<xsl:call-template name="altova:Section_06B6B2A8_FooterRight"/>
			<xsl:text>}</xsl:text>
			...
			<altova:paragraph altova:selector="center" altova:character-styles="\f0\fs24" altova:paragraph-styles="\qc" altova:is-div="true">
				<altova:text-block altova:character-styles="\fs26\b" altova:character-reset-styles="\fs24\b0">
					<xsl:text>\u65?\u108?\u108?\u32?\u68?\u111?\u109?\u97?\u105?\u110?\u115?\u32?\u68?\u101?\u116?\u97?\u105?\u108?\u115?</xsl:text>
				</altova:text-block>
			</altova:paragraph>
			<altova:new-line/>
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:root">
					<altova:new-line/>
					<altova:new-line/>
					<xsl:variable name="altova:CurrContextGrid_084DA388" select="."/>
					...
					<xsl:for-each select="n1:DomainsCollection">
						<xsl:for-each select="n1:DomainDetails">
							...
							<xsl:text>{</xsl:text>
							<xsl:text>\footerl </xsl:text>
							<xsl:call-template name="altova:Section_084D8B30_FooterLeft"/>
							<xsl:text>}</xsl:text>
							<xsl:text>{</xsl:text>
							<xsl:text>\footerr </xsl:text>
							<xsl:call-template name="altova:Section_084D8B30_FooterRight"/>
							<xsl:text>}</xsl:text>
							<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="56" altova:MarginRightPt="56"/>
							<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
							<xsl:variable name="altova:CurrContextGrid_0A701A30" select="."/>
							<xsl:variable name="altova:ColumnData">
								<altova:Internal/>
							</xsl:variable>
							<altova:table>
							...
							<xsl:if test="count( n1:ConstraintsCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_0A5CAF28" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
									<altova:UsesDefaultWidth/>
								</xsl:variable>
								<altova:table>
									...
									<xsl:variable name="altova:nColumnsWithDefaultWidth_2" select="count($altova:ColumnData//altova:UsesDefaultWidth)"/>
											...
											<altova:table-row>
												...
												<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
													<xsl:if test="count( n1:RangesCollection )">
														<xsl:variable name="altova:CurrContextGrid_0B553158" select="."/>
														<xsl:variable name="altova:ColumnData">
															<altova:Internal/>
														</xsl:variable>
														<altova:table>
													...
													<xsl:if test="count( n1:ValueListsCollection ) != 0">
														<xsl:variable name="altova:CurrContextGrid_09BD3EC0" select="."/>
														<xsl:variable name="altova:ColumnData">
															<altova:Internal/>
														</xsl:variable>
														<altova:table>
													...
													<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
														<xsl:variable name="altova:CurrContextGrid_081D6AC8" select="."/>
														<xsl:variable name="altova:ColumnData">
															<altova:Internal/>
														</xsl:variable>
														<altova:table>
							...
							<xsl:if test="count( n1:TablesCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_08000D28" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
							...
							<xsl:if test="count( n1:EntitiesCollection)">
								...
								<xsl:variable name="altova:CurrContextGrid_06B6D380" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
	...
	<xsl:template name="altova:Section_06B6B2A8_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_084D7C50" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_06B6B2A8_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_084D7C50" select="."/>
		<xsl:variable name="altova:ColumnData">
	...
	<xsl:template name="altova:Section_084D8B30_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0A549C98" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_084D8B30_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0A549C98" select="."/>
		<xsl:variable name="altova:ColumnData">
