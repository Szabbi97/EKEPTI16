...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_cr" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
		...
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<altova:paragraph altova:selector="center" altova:character-styles="\f0\fs24" altova:paragraph-styles="\qc" altova:is-div="true">
				<altova:text-block altova:character-styles="\fs26\b" altova:character-reset-styles="\fs24\b0">
					<xsl:text>\u67?\u104?\u97?\u110?\u103?\u101?\u32?\u82?\u101?\u113?\u117?\u101?\u115?\u116?\u115?\u32?\u68?\u101?\u116?\u97?\u105?\u108?\u115?</xsl:text>
				</altova:text-block>
			</altova:paragraph>
			<altova:new-line/>
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:root">
					<altova:new-line/>
					<xsl:variable name="altova:CurrContextGrid_084D4B30" select="."/>
					...
					<xsl:for-each select="n1:CRCollection">
						<xsl:for-each select="n1:CRDetails">
							...
							<xsl:text>{</xsl:text>
							<xsl:text>\footerl </xsl:text>
							<xsl:call-template name="altova:Section_084F31E8_FooterLeft"/>
							<xsl:text>}</xsl:text>
							<xsl:text>{</xsl:text>
							<xsl:text>\footerr </xsl:text>
							<xsl:call-template name="altova:Section_084F31E8_FooterRight"/>
							<xsl:text>}</xsl:text>
							<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="56" altova:MarginRightPt="56"/>
							<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
							<xsl:variable name="altova:CurrContextGrid_09B49120" select="."/>
							<xsl:variable name="altova:ColumnData">
								<altova:Internal/>
							</xsl:variable>
							<altova:table>
							...
							<xsl:if test="count(n1:CRUsedInObjectCollection/n1:CRUsedInObjectDetails)">
								...
								<xsl:variable name="altova:CurrContextGrid_0A9C55E0" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_2_2 = $altova:nDefaultColumnWidthTw_2) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_2" select="$altova:CurrGridPos_2 + $altova:nColumnWidthTw_2_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_2)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
	...
	<xsl:template name="altova:Section_06B6B2A8_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_084ED2A8" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_084F31E8_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0B53F118" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_084F31E8_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0B53F118" select="."/>
		<xsl:variable name="altova:ColumnData">
