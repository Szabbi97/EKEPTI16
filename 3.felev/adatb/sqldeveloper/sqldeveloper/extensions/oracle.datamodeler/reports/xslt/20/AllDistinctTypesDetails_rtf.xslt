...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_a_dt" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:call-template name="altova:Section_0D0F5F30_FooterLeft"/>
			<xsl:text>}</xsl:text>
			<xsl:text>{</xsl:text>
			<xsl:text>\footerr </xsl:text>
			<xsl:call-template name="altova:Section_0D0F5F30_FooterRight"/>
			<xsl:text>}</xsl:text>
			...
			<altova:paragraph altova:selector="center" altova:character-styles="\f0\fs24" altova:paragraph-styles="\qc" altova:is-div="true">
				<altova:text-block altova:character-styles="\fs26\b" altova:character-reset-styles="\fs24\b0">
					<xsl:text>\u65?\u108?\u108?\u32?\u68?\u105?\u115?\u116?\u105?\u110?\u99?\u116?\u32?\u84?\u121?\u112?\u101?\u115?\u32?\u68?\u101?\u116?\u97?\u105?\u108?\u115?</xsl:text>
				</altova:text-block>
			</altova:paragraph>
			<altova:new-line/>
				...
				<xsl:for-each select="n1:root">
					...
					<xsl:for-each select="n1:DTCollection">
						<xsl:for-each select="n1:DTDetails">
							...
							<xsl:text>{</xsl:text>
							<xsl:text>\footerl </xsl:text>
							<xsl:call-template name="altova:Section_0F9043A8_FooterLeft"/>
							<xsl:text>}</xsl:text>
							<xsl:text>{</xsl:text>
							<xsl:text>\footerr </xsl:text>
							<xsl:call-template name="altova:Section_0F9043A8_FooterRight"/>
							<xsl:text>}</xsl:text>
							<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="56" altova:MarginRightPt="56"/>
							<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
	...
	<xsl:template name="altova:Section_0D0F5F30_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
	...
	<xsl:template name="altova:Section_0D0F5F30_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_084B2A18" select="."/>
		<xsl:variable name="altova:ColumnData">
	...
	<xsl:template name="altova:Section_0F9043A8_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
	...
	<xsl:template name="altova:Section_0F9043A8_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0F850AA0" select="."/>
		<xsl:variable name="altova:ColumnData">
