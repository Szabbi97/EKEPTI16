...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_ae" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:call-template name="altova:Section_0A490970_FooterLeft"/>
			<xsl:text>}</xsl:text>
			<xsl:text>{</xsl:text>
			<xsl:text>\footerr </xsl:text>
			<xsl:call-template name="altova:Section_0A490970_FooterRight"/>
			<xsl:text>}</xsl:text>
			<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="56" altova:MarginRightPt="56"/>
			...
			<altova:paragraph altova:selector="center" altova:character-styles="\f0\fs24" altova:paragraph-styles="\qc" altova:is-div="true">
				<altova:text-block altova:character-styles="\fs26\b" altova:character-reset-styles="\fs24\b0">
					<xsl:text>\u65?\u108?\u108?\u32?\u69?\u110?\u116?\u105?\u116?\u105?\u101?\u115?\u32?\u68?\u101?\u116?\u97?\u105?\u108?\u115?</xsl:text>
				</altova:text-block>
			</altova:paragraph>
			<altova:new-line/>
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:root">
					<altova:new-line/>
					<altova:new-line/>
					<xsl:variable name="altova:CurrContextGrid_0BC708D8" select="."/>
					...
					<altova:table>
						...
						<altova:table-row>
							<xsl:variable name="altova:RowStyle">
								...
								<xsl:text>\brdrcf3</xsl:text>
								<xsl:text>\brdrw28</xsl:text>
								<xsl:text>\clpadl45\clpadfl3</xsl:text>
								<xsl:text>\clpadb45\clpadfb3</xsl:text>
								<xsl:text>\clpadt45\clpadft3</xsl:text>
								<xsl:text>\clpadr45\clpadfr3</xsl:text>
								<xsl:value-of select="if ($altova:nColumnWidthTw_0_0 = $altova:nDefaultColumnWidthTw_0) then '\clftsWidth1' else ()"/>
								...
								<xsl:text>\clpadt45\clpadft3</xsl:text>
								<xsl:text>\clpadr45\clpadfr3</xsl:text>
								<xsl:value-of select="if ($altova:nColumnWidthTw_0_1 = $altova:nDefaultColumnWidthTw_0) then '\clftsWidth1' else ()"/>
								<xsl:text>\cellx</xsl:text>
							...
							<xsl:if test="$templatetablelevel + 1 = 1">
								<xsl:copy-of select="$tablestyle0"/>
								<xsl:copy-of select="$altova:RowStyle"/>
							</xsl:if>
							...
							<xsl:element name="altova:NestedTablePropertiesBegin"/>
							<xsl:copy-of select="$tablestyle0"/>
							<xsl:copy-of select="$altova:RowStyle"/>
						</altova:table-row>
						<altova:table-row>
					...
					<xsl:for-each select="n1:EntitiesCollection">
						<xsl:for-each select="n1:EntityDetails">
							...
							<xsl:text>{</xsl:text>
							<xsl:text>\footerl </xsl:text>
							<xsl:call-template name="altova:Section_0E74EE80_FooterLeft"/>
							<xsl:text>}</xsl:text>
							<xsl:text>{</xsl:text>
							<xsl:text>\footerr </xsl:text>
							<xsl:call-template name="altova:Section_0E74EE80_FooterRight"/>
							<xsl:text>}</xsl:text>
							<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="56" altova:MarginRightPt="56"/>
							<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
							<xsl:variable name="altova:CurrContextGrid_084E7188" select="."/>
							<xsl:variable name="altova:ColumnData">
								<altova:Internal/>
							</xsl:variable>
							<altova:table>
								...
								<xsl:variable name="tablestyle1">
									...
									<xsl:text>\trspdl0\trspdt0\trspdb0\trspdr0\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt0\trpaddl0\trpaddb0\trpaddr0\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
								</xsl:variable>
								<altova:table-row>
									<xsl:variable name="altova:RowStyle">
										<xsl:text>\trrh0</xsl:text>
										<xsl:variable name="altova:CurrGridPos_1" select="$altova:nTableIndentTw_1"/>
										<xsl:text/>
										<xsl:text>\clvertalc</xsl:text>
										<xsl:text>\clpadl0\clpadfl3</xsl:text>
										<xsl:text>\clpadb0\clpadfb3</xsl:text>
										<xsl:text>\clpadt0\clpadft3</xsl:text>
										<xsl:text>\clpadr0\clpadfr3</xsl:text>
										<xsl:value-of select="if ($altova:nColumnWidthTw_1_0 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
										<xsl:text>\cellx</xsl:text>
										<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_0"/>
										...
										<xsl:text>\clpadt0\clpadft3</xsl:text>
										<xsl:text>\clpadr0\clpadfr3</xsl:text>
										<xsl:value-of select="if ($altova:nColumnWidthTw_1_1 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
										<xsl:text>\cellx</xsl:text>
										<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_1"/>
										<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										<xsl:text/>
										...
										<xsl:text>\clpadt0\clpadft3</xsl:text>
										<xsl:text>\clpadr0\clpadfr3</xsl:text>
										<xsl:value-of select="if ($altova:nColumnWidthTw_1_2 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
										<xsl:text>\cellx</xsl:text>
										<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_2"/>
										<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
									</xsl:variable>
									<xsl:if test="$templatetablelevel + 1 = 1">
										<xsl:copy-of select="$tablestyle1"/>
										<xsl:copy-of select="$altova:RowStyle"/>
									</xsl:if>
									<altova:table-cell altova:paragraph-styles="\sl0">
										<xsl:variable name="altova:CurrContextGrid_084E7810" select="."/>
										<xsl:variable name="altova:ColumnData">
											<altova:Internal/>
										</xsl:variable>
										<altova:table>
											...
											<altova:table-row>
												<xsl:variable name="altova:RowStyle">
													<xsl:text>\trrh0</xsl:text>
													<xsl:variable name="altova:CurrGridPos_2" select="$altova:nTableIndentTw_2"/>
													<xsl:text/>
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
														<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
													...
													<xsl:text>\clpadt45\clpadft3</xsl:text>
													<xsl:text>\clpadr45\clpadfr3</xsl:text>
													<xsl:value-of select="if ($altova:nColumnWidthTw_2_0 = $altova:nDefaultColumnWidthTw_2) then '\clftsWidth1' else ()"/>
													<xsl:text>\cellx</xsl:text>
													<xsl:variable name="altova:CurrGridPos_2" select="$altova:CurrGridPos_2 + $altova:nColumnWidthTw_2_0"/>
													<xsl:value-of select="ceiling($altova:CurrGridPos_2)"/>
													<xsl:text/>
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
													...
													<xsl:text>\clpadt45\clpadft3</xsl:text>
													<xsl:text>\clpadr45\clpadfr3</xsl:text>
													<xsl:value-of select="if ($altova:nColumnWidthTw_2_1 = $altova:nDefaultColumnWidthTw_2) then '\clftsWidth1' else ()"/>
													<xsl:text>\cellx</xsl:text>
													<xsl:variable name="altova:CurrGridPos_2" select="$altova:CurrGridPos_2 + $altova:nColumnWidthTw_2_1"/>
													<xsl:value-of select="ceiling($altova:CurrGridPos_2)"/>
												</xsl:variable>
												<xsl:if test="$templatetablelevel + 2 = 1">
													<xsl:copy-of select="$tablestyle2"/>
													<xsl:copy-of select="$altova:RowStyle"/>
												</xsl:if>
												<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
													<altova:text-block>
									...
									<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
										<xsl:if test="count( n1:MappedTablesCollection )">
											...
											<altova:new-line/>
											<xsl:variable name="altova:CurrContextGrid_0A55FB20" select="."/>
											<xsl:variable name="altova:ColumnData">
												<altova:Internal/>
											</xsl:variable>
											<altova:table>
												...
												<altova:table-row>
													<xsl:variable name="altova:RowStyle">
														<xsl:text>\trrh0</xsl:text>
														<xsl:variable name="altova:CurrGridPos_3" select="$altova:nTableIndentTw_3"/>
														<xsl:text/>
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
														...
														<xsl:text>\clpadt45\clpadft3</xsl:text>
														<xsl:text>\clpadr45\clpadfr3</xsl:text>
														<xsl:value-of select="if ($altova:nColumnWidthTw_3_0 = $altova:nDefaultColumnWidthTw_3) then '\clftsWidth1' else ()"/>
														<xsl:text>\cellx</xsl:text>
														<xsl:variable name="altova:CurrGridPos_3" select="$altova:CurrGridPos_3 + $altova:nColumnWidthTw_3_0"/>
														<xsl:value-of select="ceiling($altova:CurrGridPos_3)"/>
													</xsl:variable>
													<xsl:if test="$templatetablelevel + 2 = 1">
														<xsl:copy-of select="$tablestyle3"/>
														<xsl:copy-of select="$altova:RowStyle"/>
													</xsl:if>
							...
							<xsl:if test="count( n1:DescriptionNotes )">
								...
								<xsl:for-each select="n1:DescriptionNotes">
									<xsl:variable name="altova:CurrContextGrid_0EA14B78" select="."/>
									<xsl:variable name="altova:ColumnData">
										<altova:Internal/>
									</xsl:variable>
									<altova:table>
										...
										<altova:table-row>
											<xsl:variable name="altova:RowStyle">
												<xsl:text>\trrh0</xsl:text>
												<xsl:variable name="altova:CurrGridPos_4" select="$altova:nTableIndentTw_4"/>
												<xsl:text/>
												<xsl:text>\clvertalc</xsl:text>
												<xsl:element name="altova:TableCellColor">
													<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
												...
												<xsl:text>\clpadt45\clpadft3</xsl:text>
												<xsl:text>\clpadr45\clpadfr3</xsl:text>
												<xsl:value-of select="if ($altova:nColumnWidthTw_4_0 = $altova:nDefaultColumnWidthTw_4) then '\clftsWidth1' else ()"/>
												<xsl:text>\cellx</xsl:text>
												<xsl:variable name="altova:CurrGridPos_4" select="$altova:CurrGridPos_4 + $altova:nColumnWidthTw_4_0"/>
												<xsl:value-of select="ceiling($altova:CurrGridPos_4)"/>
												<xsl:text/>
												<xsl:text>\clvertalc</xsl:text>
												<xsl:text>\clbrdrt</xsl:text>
												<xsl:text>\brdrs</xsl:text>
												...
												<xsl:text>\clpadt45\clpadft3</xsl:text>
												<xsl:text>\clpadr45\clpadfr3</xsl:text>
												<xsl:value-of select="if ($altova:nColumnWidthTw_4_1 = $altova:nDefaultColumnWidthTw_4) then '\clftsWidth1' else ()"/>
												<xsl:text>\cellx</xsl:text>
												<xsl:variable name="altova:CurrGridPos_4" select="$altova:CurrGridPos_4 + $altova:nColumnWidthTw_4_1"/>
												<xsl:value-of select="ceiling($altova:CurrGridPos_4)"/>
											</xsl:variable>
											<xsl:if test="$templatetablelevel + 1 = 1">
												<xsl:copy-of select="$tablestyle4"/>
												<xsl:copy-of select="$altova:RowStyle"/>
											</xsl:if>
											<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
												<altova:text-block>
							...
							<xsl:if test="count( n1:QuantitativeInfoCollection )">
								...
								<xsl:for-each select="n1:QuantitativeInfoCollection">
									<xsl:variable name="altova:CurrContextGrid_084D0B30" select="."/>
									<xsl:variable name="altova:ColumnData">
										<altova:Internal/>
									</xsl:variable>
									<altova:table>
										...
										<altova:table-row>
											<xsl:variable name="altova:RowStyle">
												<xsl:text>\trrh0</xsl:text>
												<xsl:variable name="altova:CurrGridPos_5" select="$altova:nTableIndentTw_5"/>
												<xsl:text/>
												<xsl:text>\clvertalc</xsl:text>
												<xsl:element name="altova:TableCellColor">
													<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
												...
												<xsl:text>\clpadt45\clpadft3</xsl:text>
												<xsl:text>\clpadr45\clpadfr3</xsl:text>
												<xsl:value-of select="if ($altova:nColumnWidthTw_5_0 = $altova:nDefaultColumnWidthTw_5) then '\clftsWidth1' else ()"/>
												<xsl:text>\cellx</xsl:text>
												<xsl:variable name="altova:CurrGridPos_5" select="$altova:CurrGridPos_5 + $altova:nColumnWidthTw_5_0"/>
												<xsl:value-of select="ceiling($altova:CurrGridPos_5)"/>
												<xsl:text/>
												<xsl:text>\clvertalc</xsl:text>
												<xsl:text>\clbrdrt</xsl:text>
												<xsl:text>\brdrs</xsl:text>
												...
												<xsl:text>\clpadt45\clpadft3</xsl:text>
												<xsl:text>\clpadr45\clpadfr3</xsl:text>
												<xsl:value-of select="if ($altova:nColumnWidthTw_5_1 = $altova:nDefaultColumnWidthTw_5) then '\clftsWidth1' else ()"/>
												<xsl:text>\cellx</xsl:text>
												<xsl:variable name="altova:CurrGridPos_5" select="$altova:CurrGridPos_5 + $altova:nColumnWidthTw_5_1"/>
												<xsl:value-of select="ceiling($altova:CurrGridPos_5)"/>
											</xsl:variable>
											<xsl:if test="$templatetablelevel + 1 = 1">
												<xsl:copy-of select="$tablestyle5"/>
												<xsl:copy-of select="$altova:RowStyle"/>
											</xsl:if>
											<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
												<altova:text-block>
							...
							<xsl:if test="count( n1:AttributesCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_0F560E28" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											...
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:nTableIndentTw_6"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_6_0 = $altova:nDefaultColumnWidthTw_6) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:CurrGridPos_6 + $altova:nColumnWidthTw_6_0"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_6)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_6_1 = $altova:nDefaultColumnWidthTw_6) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:CurrGridPos_6 + $altova:nColumnWidthTw_6_1"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_6)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_6_2 = $altova:nDefaultColumnWidthTw_6) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:CurrGridPos_6 + $altova:nColumnWidthTw_6_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_6)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_6_3 = $altova:nDefaultColumnWidthTw_6) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:CurrGridPos_6 + $altova:nColumnWidthTw_6_3"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_6)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_6_4 = $altova:nDefaultColumnWidthTw_6) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:CurrGridPos_6 + $altova:nColumnWidthTw_6_4"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_6)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_6_5 = $altova:nDefaultColumnWidthTw_6) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:CurrGridPos_6 + $altova:nColumnWidthTw_6_5"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_6)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_6_6 = $altova:nDefaultColumnWidthTw_6) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:CurrGridPos_6 + $altova:nColumnWidthTw_6_6"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_6)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_6_7 = $altova:nDefaultColumnWidthTw_6) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:CurrGridPos_6 + $altova:nColumnWidthTw_6_7"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_6)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_6_8 = $altova:nDefaultColumnWidthTw_6) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:CurrGridPos_6 + $altova:nColumnWidthTw_6_8"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_6)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_6_9 = $altova:nDefaultColumnWidthTw_6) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:CurrGridPos_6 + $altova:nColumnWidthTw_6_9"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_6)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_6_10 = $altova:nDefaultColumnWidthTw_6) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_6" select="$altova:CurrGridPos_6 + $altova:nColumnWidthTw_6_10"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_6)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
											<xsl:copy-of select="$tablestyle6"/>
											<xsl:copy-of select="$altova:RowStyle"/>
										</xsl:if>
							...
							<xsl:if test="count( n1:AttributesCommentsCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_09886100" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											<xsl:text>\trrh0\trhdr</xsl:text>
											<xsl:variable name="altova:CurrGridPos_7" select="$altova:nTableIndentTw_7"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_7_0 = $altova:nDefaultColumnWidthTw_7) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_7" select="$altova:CurrGridPos_7 + $altova:nColumnWidthTw_7_0"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_7)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_7_1 = $altova:nDefaultColumnWidthTw_7) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_7" select="$altova:CurrGridPos_7 + $altova:nColumnWidthTw_7_1"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_7)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_7_2 = $altova:nDefaultColumnWidthTw_7) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_7" select="$altova:CurrGridPos_7 + $altova:nColumnWidthTw_7_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_7)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_7_3 = $altova:nDefaultColumnWidthTw_7) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_7" select="$altova:CurrGridPos_7 + $altova:nColumnWidthTw_7_3"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_7)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
											<xsl:copy-of select="$tablestyle7"/>
											<xsl:copy-of select="$altova:RowStyle"/>
										</xsl:if>
										<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
											<altova:text-block>
							...
							<xsl:if test="count( n1:ConstraintsCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_0BC54228" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											<xsl:text>\trrh0\trhdr</xsl:text>
											<xsl:variable name="altova:CurrGridPos_8" select="$altova:nTableIndentTw_8"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_8_0 = $altova:nDefaultColumnWidthTw_8) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_8" select="$altova:CurrGridPos_8 + $altova:nColumnWidthTw_8_0"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_8)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_8_1 = $altova:nDefaultColumnWidthTw_8) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_8" select="$altova:CurrGridPos_8 + $altova:nColumnWidthTw_8_1"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_8)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_8_2 = $altova:nDefaultColumnWidthTw_8) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_8" select="$altova:CurrGridPos_8 + $altova:nColumnWidthTw_8_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_8)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
											<xsl:copy-of select="$tablestyle8"/>
											<xsl:copy-of select="$altova:RowStyle"/>
										</xsl:if>
										<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
											<altova:text-block>
											...
											<altova:table-row>
												...
												<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
													<xsl:if test="count( n1:RangesCollection ) != 0">
														<xsl:variable name="altova:CurrContextGrid_08402108" select="."/>
														<xsl:variable name="altova:ColumnData">
															<altova:Internal/>
														</xsl:variable>
														<altova:table>
															...
															<altova:table-row>
																<xsl:variable name="altova:RowStyle">
																	<xsl:text>\trrh0\trhdr</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_9" select="$altova:nTableIndentTw_9"/>
																	...
																	<xsl:text>\clpadt45\clpadft3</xsl:text>
																	<xsl:text>\clpadr45\clpadfr3</xsl:text>
																	<xsl:value-of select="if ($altova:nColumnWidthTw_9_0 = $altova:nDefaultColumnWidthTw_9) then '\clftsWidth1' else ()"/>
																	<xsl:text>\cellx</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_9" select="$altova:CurrGridPos_9 + $altova:nColumnWidthTw_9_0"/>
																	<xsl:value-of select="ceiling($altova:CurrGridPos_9)"/>
																	...
																	<xsl:text>\clpadt45\clpadft3</xsl:text>
																	<xsl:text>\clpadr45\clpadfr3</xsl:text>
																	<xsl:value-of select="if ($altova:nColumnWidthTw_9_1 = $altova:nDefaultColumnWidthTw_9) then '\clftsWidth1' else ()"/>
																	<xsl:text>\cellx</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_9" select="$altova:CurrGridPos_9 + $altova:nColumnWidthTw_9_1"/>
																	<xsl:value-of select="ceiling($altova:CurrGridPos_9)"/>
																	<xsl:text>\clmrg</xsl:text>
																	<xsl:text>\clvertalc</xsl:text>
																	<xsl:element name="altova:TableCellColor">
																	...
																	<xsl:text>\clpadt45\clpadft3</xsl:text>
																	<xsl:text>\clpadr45\clpadfr3</xsl:text>
																	<xsl:value-of select="if ($altova:nColumnWidthTw_9_2 = $altova:nDefaultColumnWidthTw_9) then '\clftsWidth1' else ()"/>
																	<xsl:text>\cellx</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_9" select="$altova:CurrGridPos_9 + $altova:nColumnWidthTw_9_2"/>
																	<xsl:value-of select="ceiling($altova:CurrGridPos_9)"/>
																</xsl:variable>
																<xsl:if test="$templatetablelevel + 2 = 1">
																	<xsl:copy-of select="$tablestyle9"/>
																	<xsl:copy-of select="$altova:RowStyle"/>
																</xsl:if>
																<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																	<altova:text-block>
													...
													<xsl:if test="count( n1:ValueListsCollection ) != 0">
														<xsl:variable name="altova:CurrContextGrid_086A6A60" select="."/>
														<xsl:variable name="altova:ColumnData">
															<altova:Internal/>
														</xsl:variable>
														<altova:table>
															...
															<altova:table-row>
																<xsl:variable name="altova:RowStyle">
																	<xsl:text>\trrh0\trhdr</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_10" select="$altova:nTableIndentTw_10"/>
																	<xsl:text>\clmgf</xsl:text>
																	<xsl:text>\clvertalc</xsl:text>
																	<xsl:element name="altova:TableCellColor">
																		<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
																	...
																	<xsl:text>\clpadt45\clpadft3</xsl:text>
																	<xsl:text>\clpadr45\clpadfr3</xsl:text>
																	<xsl:value-of select="if ($altova:nColumnWidthTw_10_0 = $altova:nDefaultColumnWidthTw_10) then '\clftsWidth1' else ()"/>
																	<xsl:text>\cellx</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_10" select="$altova:CurrGridPos_10 + $altova:nColumnWidthTw_10_0"/>
																	<xsl:value-of select="ceiling($altova:CurrGridPos_10)"/>
																	<xsl:text>\clmrg</xsl:text>
																	<xsl:text>\clvertalc</xsl:text>
																	<xsl:element name="altova:TableCellColor">
																		<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
																	...
																	<xsl:text>\clpadt45\clpadft3</xsl:text>
																	<xsl:text>\clpadr45\clpadfr3</xsl:text>
																	<xsl:value-of select="if ($altova:nColumnWidthTw_10_1 = $altova:nDefaultColumnWidthTw_10) then '\clftsWidth1' else ()"/>
																	<xsl:text>\cellx</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_10" select="$altova:CurrGridPos_10 + $altova:nColumnWidthTw_10_1"/>
																	<xsl:value-of select="ceiling($altova:CurrGridPos_10)"/>
																</xsl:variable>
																<xsl:if test="$templatetablelevel + 2 = 1">
																	<xsl:copy-of select="$tablestyle10"/>
																	<xsl:copy-of select="$altova:RowStyle"/>
																</xsl:if>
																<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																	<altova:text-block>
													...
													<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
														<xsl:variable name="altova:CurrContextGrid_083AF500" select="."/>
														<xsl:variable name="altova:ColumnData">
															<altova:Internal/>
														</xsl:variable>
														<altova:table>
															...
															<altova:table-row>
																<xsl:variable name="altova:RowStyle">
																	<xsl:text>\trrh0\trhdr</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_11" select="$altova:nTableIndentTw_11"/>
																	<xsl:text>\clmgf</xsl:text>
																	<xsl:text>\clvertalc</xsl:text>
																	<xsl:element name="altova:TableCellColor">
																		<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
																	...
																	<xsl:text>\clpadt45\clpadft3</xsl:text>
																	<xsl:text>\clpadr45\clpadfr3</xsl:text>
																	<xsl:value-of select="if ($altova:nColumnWidthTw_11_0 = $altova:nDefaultColumnWidthTw_11) then '\clftsWidth1' else ()"/>
																	<xsl:text>\cellx</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_11" select="$altova:CurrGridPos_11 + $altova:nColumnWidthTw_11_0"/>
																	<xsl:value-of select="ceiling($altova:CurrGridPos_11)"/>
																	<xsl:text>\clmrg</xsl:text>
																	<xsl:text>\clvertalc</xsl:text>
																	<xsl:element name="altova:TableCellColor">
																		<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
																	...
																	<xsl:text>\clpadt45\clpadft3</xsl:text>
																	<xsl:text>\clpadr45\clpadfr3</xsl:text>
																	<xsl:value-of select="if ($altova:nColumnWidthTw_11_1 = $altova:nDefaultColumnWidthTw_11) then '\clftsWidth1' else ()"/>
																	<xsl:text>\cellx</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_11" select="$altova:CurrGridPos_11 + $altova:nColumnWidthTw_11_1"/>
																	<xsl:value-of select="ceiling($altova:CurrGridPos_11)"/>
																</xsl:variable>
																<xsl:if test="$templatetablelevel + 2 = 1">
																	<xsl:copy-of select="$tablestyle11"/>
																	<xsl:copy-of select="$altova:RowStyle"/>
																</xsl:if>
																<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																	<altova:text-block>
							...
							<xsl:if test="count( n1:IdentifiersCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_08471B40" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<xsl:variable name="altova:nColumnWidthTw_12_1" select="round(0.79 * 1440 * $altova:TableWidthFactor_12)"/>
									<xsl:variable name="altova:nColumnWidthTw_12_2" select="round(2.36 * 1440 * $altova:TableWidthFactor_12)"/>
									<xsl:variable name="altova:nColumnWidthTw_12_3" select="round(0.79 * 1440 * $altova:TableWidthFactor_12)"/>
									<xsl:variable name="altova:nColumnWidthTw_12_4" select="round(1.57 * 1440 * $altova:TableWidthFactor_12)"/>
									<xsl:variable name="altova:nColumnWidthTw_12_5" select="round(1.57 * 1440 * $altova:TableWidthFactor_12)"/>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											<xsl:text>\trrh0\trhdr</xsl:text>
											<xsl:variable name="altova:CurrGridPos_12" select="$altova:nTableIndentTw_12"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_12_0 = $altova:nDefaultColumnWidthTw_12) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_12" select="$altova:CurrGridPos_12 + $altova:nColumnWidthTw_12_0"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_12)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_12_1 = $altova:nDefaultColumnWidthTw_12) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_12" select="$altova:CurrGridPos_12 + $altova:nColumnWidthTw_12_1"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_12)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_12_2 = $altova:nDefaultColumnWidthTw_12) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_12" select="$altova:CurrGridPos_12 + $altova:nColumnWidthTw_12_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_12)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_12_3 = $altova:nDefaultColumnWidthTw_12) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_12" select="$altova:CurrGridPos_12 + $altova:nColumnWidthTw_12_3"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_12)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_12_4 = $altova:nDefaultColumnWidthTw_12) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_12" select="$altova:CurrGridPos_12 + $altova:nColumnWidthTw_12_4"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_12)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_12_5 = $altova:nDefaultColumnWidthTw_12) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_12" select="$altova:CurrGridPos_12 + $altova:nColumnWidthTw_12_5"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_12)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
											<xsl:copy-of select="$tablestyle12"/>
											<xsl:copy-of select="$altova:RowStyle"/>
										</xsl:if>
										<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
											<altova:text-block>
							...
							<xsl:if test="count( n1:RelationshipsCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_093858E0" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_13" select="round(14177.23)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_13_0" select="round(1.97 * 1440 * $altova:TableWidthFactor_13)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_13_4" select="round(0.98 * 1440 * $altova:TableWidthFactor_13)"/>
									<xsl:variable name="altova:nColumnWidthTw_13_5" select="round(0.98 * 1440 * $altova:TableWidthFactor_13)"/>
									<xsl:variable name="altova:nColumnWidthTw_13_6" select="round(0.98 * 1440 * $altova:TableWidthFactor_13)"/>
									<xsl:variable name="altova:nColumnWidthTw_13_7" select="round(0.98 * 1440 * $altova:TableWidthFactor_13)"/>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											<xsl:text>\trrh0\trhdr</xsl:text>
											<xsl:variable name="altova:CurrGridPos_13" select="$altova:nTableIndentTw_13"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_13_0 = $altova:nDefaultColumnWidthTw_13) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_13" select="$altova:CurrGridPos_13 + $altova:nColumnWidthTw_13_0"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_13)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_13_1 = $altova:nDefaultColumnWidthTw_13) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_13" select="$altova:CurrGridPos_13 + $altova:nColumnWidthTw_13_1"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_13)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_13_2 = $altova:nDefaultColumnWidthTw_13) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_13" select="$altova:CurrGridPos_13 + $altova:nColumnWidthTw_13_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_13)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_13_3 = $altova:nDefaultColumnWidthTw_13) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_13" select="$altova:CurrGridPos_13 + $altova:nColumnWidthTw_13_3"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_13)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_13_4 = $altova:nDefaultColumnWidthTw_13) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_13" select="$altova:CurrGridPos_13 + $altova:nColumnWidthTw_13_4"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_13)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_13_5 = $altova:nDefaultColumnWidthTw_13) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_13" select="$altova:CurrGridPos_13 + $altova:nColumnWidthTw_13_5"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_13)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_13_6 = $altova:nDefaultColumnWidthTw_13) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_13" select="$altova:CurrGridPos_13 + $altova:nColumnWidthTw_13_6"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_13)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_13_7 = $altova:nDefaultColumnWidthTw_13) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_13" select="$altova:CurrGridPos_13 + $altova:nColumnWidthTw_13_7"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_13)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
											<xsl:copy-of select="$tablestyle13"/>
											<xsl:copy-of select="$altova:RowStyle"/>
										</xsl:if>
										<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
											<altova:text-block>
													...
													<xsl:choose>
														<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
															<xsl:for-each select="n1:Identifying">
																<altova:text-block>
																	<xsl:apply-templates>
																		<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_13_6 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
																	</xsl:apply-templates>
																</altova:text-block>
															</xsl:for-each>
														</xsl:when>
													...
													<xsl:choose>
														<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
															<xsl:for-each select="n1:Transferable">
																<altova:text-block>
																	<xsl:apply-templates>
																		<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_13_7 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
																	</xsl:apply-templates>
																</altova:text-block>
															</xsl:for-each>
														</xsl:when>
							...
							<xsl:if test="count( n1:IncomingProcessesCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_083CCED8" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_14" select="round(14175.23)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_14_0" select="round(2.95 * 1440 * $altova:TableWidthFactor_14)"/>
									<xsl:variable name="altova:nColumnWidthTw_14_1" select="round(2.95 * 1440 * $altova:TableWidthFactor_14)"/>
									<xsl:variable name="altova:nColumnWidthTw_14_2" select="round(0.98 * 1440 * $altova:TableWidthFactor_14)"/>
									<xsl:variable name="altova:nColumnWidthTw_14_3" select="round(2.95 * 1440 * $altova:TableWidthFactor_14)"/>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											<xsl:text>\trrh0\trhdr</xsl:text>
											<xsl:variable name="altova:CurrGridPos_14" select="$altova:nTableIndentTw_14"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_14_0 = $altova:nDefaultColumnWidthTw_14) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_14" select="$altova:CurrGridPos_14 + $altova:nColumnWidthTw_14_0"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_14)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_14_1 = $altova:nDefaultColumnWidthTw_14) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_14" select="$altova:CurrGridPos_14 + $altova:nColumnWidthTw_14_1"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_14)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_14_2 = $altova:nDefaultColumnWidthTw_14) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_14" select="$altova:CurrGridPos_14 + $altova:nColumnWidthTw_14_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_14)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_14_3 = $altova:nDefaultColumnWidthTw_14) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_14" select="$altova:CurrGridPos_14 + $altova:nColumnWidthTw_14_3"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_14)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
											<xsl:copy-of select="$tablestyle14"/>
											<xsl:copy-of select="$altova:RowStyle"/>
										</xsl:if>
										<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
											<altova:text-block>
							...
							<xsl:if test="count( n1:OutgoingProcessesCollection ) !=0">
								...
								<xsl:variable name="altova:CurrContextGrid_083DDF30" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											<xsl:text>\trrh0\trhdr</xsl:text>
											<xsl:variable name="altova:CurrGridPos_15" select="$altova:nTableIndentTw_15"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_15_0 = $altova:nDefaultColumnWidthTw_15) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_15" select="$altova:CurrGridPos_15 + $altova:nColumnWidthTw_15_0"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_15)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_15_1 = $altova:nDefaultColumnWidthTw_15) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_15" select="$altova:CurrGridPos_15 + $altova:nColumnWidthTw_15_1"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_15)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_15_2 = $altova:nDefaultColumnWidthTw_15) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_15" select="$altova:CurrGridPos_15 + $altova:nColumnWidthTw_15_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_15)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_15_3 = $altova:nDefaultColumnWidthTw_15) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_15" select="$altova:CurrGridPos_15 + $altova:nColumnWidthTw_15_3"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_15)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
											<xsl:copy-of select="$tablestyle15"/>
											<xsl:copy-of select="$altova:RowStyle"/>
										</xsl:if>
										<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
											<altova:text-block>
	...
	<xsl:template name="altova:Section_0A490970_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_082F4F00" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
			...
			<altova:table-row>
				<xsl:variable name="altova:RowStyle">
					<xsl:text>\trrh0</xsl:text>
					<xsl:variable name="altova:CurrGridPos_16" select="$altova:nTableIndentTw_16"/>
					<xsl:text/>
					<xsl:text>\clvertalc</xsl:text>
					<xsl:text>\clpadl45\clpadfl3</xsl:text>
					<xsl:text>\clpadb45\clpadfb3</xsl:text>
					<xsl:text>\clpadt45\clpadft3</xsl:text>
					<xsl:text>\clpadr45\clpadfr3</xsl:text>
					<xsl:value-of select="if ($altova:nColumnWidthTw_16_0 = $altova:nDefaultColumnWidthTw_16) then '\clftsWidth1' else ()"/>
					<xsl:text>\cellx</xsl:text>
					<xsl:variable name="altova:CurrGridPos_16" select="$altova:CurrGridPos_16 + $altova:nColumnWidthTw_16_0"/>
					<xsl:value-of select="ceiling($altova:CurrGridPos_16)"/>
					<xsl:text/>
					<xsl:text>\clvertalc</xsl:text>
					<xsl:text>\clpadl45\clpadfl3</xsl:text>
					<xsl:text>\clpadb45\clpadfb3</xsl:text>
					<xsl:text>\clpadt45\clpadft3</xsl:text>
					<xsl:text>\clpadr45\clpadfr3</xsl:text>
					<xsl:value-of select="if ($altova:nColumnWidthTw_16_1 = $altova:nDefaultColumnWidthTw_16) then '\clftsWidth1' else ()"/>
					<xsl:text>\cellx</xsl:text>
					<xsl:variable name="altova:CurrGridPos_16" select="$altova:CurrGridPos_16 + $altova:nColumnWidthTw_16_1"/>
					<xsl:value-of select="ceiling($altova:CurrGridPos_16)"/>
				</xsl:variable>
				<xsl:if test="$templatetablelevel + 1 = 1">
					<xsl:copy-of select="$tablestyle16"/>
					<xsl:copy-of select="$altova:RowStyle"/>
				</xsl:if>
				<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
					<altova:text-block>
				...
				<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qr\sl0">
					...
					<altova:text-block/>
					<xsl:text> NUMPAGES }}{\fldrslt }}</xsl:text>
				</altova:table-cell>
				<xsl:element name="altova:NestedTablePropertiesBegin"/>
				<xsl:copy-of select="$tablestyle16"/>
				<xsl:copy-of select="$altova:RowStyle"/>
	...
	<xsl:template name="altova:Section_0A490970_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_082F4F00" select="."/>
		<xsl:variable name="altova:ColumnData">
		...
		<altova:table>
			...
			<altova:table-row>
				<xsl:variable name="altova:RowStyle">
					<xsl:text>\trrh0</xsl:text>
					<xsl:variable name="altova:CurrGridPos_17" select="$altova:nTableIndentTw_17"/>
					<xsl:text/>
					<xsl:text>\clvertalc</xsl:text>
					<xsl:text>\clpadl45\clpadfl3</xsl:text>
					<xsl:text>\clpadb45\clpadfb3</xsl:text>
					<xsl:text>\clpadt45\clpadft3</xsl:text>
					<xsl:text>\clpadr45\clpadfr3</xsl:text>
					<xsl:value-of select="if ($altova:nColumnWidthTw_17_0 = $altova:nDefaultColumnWidthTw_17) then '\clftsWidth1' else ()"/>
					<xsl:text>\cellx</xsl:text>
					<xsl:variable name="altova:CurrGridPos_17" select="$altova:CurrGridPos_17 + $altova:nColumnWidthTw_17_0"/>
					<xsl:value-of select="ceiling($altova:CurrGridPos_17)"/>
					<xsl:text/>
					<xsl:text>\clvertalc</xsl:text>
					<xsl:text>\clpadl45\clpadfl3</xsl:text>
					<xsl:text>\clpadb45\clpadfb3</xsl:text>
					<xsl:text>\clpadt45\clpadft3</xsl:text>
					<xsl:text>\clpadr45\clpadfr3</xsl:text>
					<xsl:value-of select="if ($altova:nColumnWidthTw_17_1 = $altova:nDefaultColumnWidthTw_17) then '\clftsWidth1' else ()"/>
					<xsl:text>\cellx</xsl:text>
					<xsl:variable name="altova:CurrGridPos_17" select="$altova:CurrGridPos_17 + $altova:nColumnWidthTw_17_1"/>
					<xsl:value-of select="ceiling($altova:CurrGridPos_17)"/>
				</xsl:variable>
				<xsl:if test="$templatetablelevel + 1 = 1">
					<xsl:copy-of select="$tablestyle17"/>
					<xsl:copy-of select="$altova:RowStyle"/>
				</xsl:if>
				<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
					<altova:text-block>
	...
	<xsl:template name="altova:Section_0E74EE80_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_085136C0" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
			...
			<altova:table-row>
				<xsl:variable name="altova:RowStyle">
					<xsl:text>\trrh0</xsl:text>
					<xsl:variable name="altova:CurrGridPos_18" select="$altova:nTableIndentTw_18"/>
					<xsl:text/>
					<xsl:text>\clvertalc</xsl:text>
					<xsl:text>\clpadl45\clpadfl3</xsl:text>
					<xsl:text>\clpadb45\clpadfb3</xsl:text>
					<xsl:text>\clpadt45\clpadft3</xsl:text>
					<xsl:text>\clpadr45\clpadfr3</xsl:text>
					<xsl:value-of select="if ($altova:nColumnWidthTw_18_0 = $altova:nDefaultColumnWidthTw_18) then '\clftsWidth1' else ()"/>
					<xsl:text>\cellx</xsl:text>
					<xsl:variable name="altova:CurrGridPos_18" select="$altova:CurrGridPos_18 + $altova:nColumnWidthTw_18_0"/>
					<xsl:value-of select="ceiling($altova:CurrGridPos_18)"/>
					<xsl:text/>
					<xsl:text>\clvertalc</xsl:text>
					<xsl:text>\clpadl45\clpadfl3</xsl:text>
					<xsl:text>\clpadb45\clpadfb3</xsl:text>
					<xsl:text>\clpadt45\clpadft3</xsl:text>
					<xsl:text>\clpadr45\clpadfr3</xsl:text>
					<xsl:value-of select="if ($altova:nColumnWidthTw_18_1 = $altova:nDefaultColumnWidthTw_18) then '\clftsWidth1' else ()"/>
					<xsl:text>\cellx</xsl:text>
					<xsl:variable name="altova:CurrGridPos_18" select="$altova:CurrGridPos_18 + $altova:nColumnWidthTw_18_1"/>
					<xsl:value-of select="ceiling($altova:CurrGridPos_18)"/>
				</xsl:variable>
				<xsl:if test="$templatetablelevel + 1 = 1">
					<xsl:copy-of select="$tablestyle18"/>
					<xsl:copy-of select="$altova:RowStyle"/>
				</xsl:if>
				<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
					<altova:text-block>
	...
	<xsl:template name="altova:Section_0E74EE80_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_085136C0" select="."/>
		<xsl:variable name="altova:ColumnData">
		...
		<altova:table>
			...
			<altova:table-row>
				<xsl:variable name="altova:RowStyle">
					<xsl:text>\trrh0</xsl:text>
					<xsl:variable name="altova:CurrGridPos_19" select="$altova:nTableIndentTw_19"/>
					<xsl:text/>
					<xsl:text>\clvertalc</xsl:text>
					<xsl:text>\clpadl45\clpadfl3</xsl:text>
					<xsl:text>\clpadb45\clpadfb3</xsl:text>
					<xsl:text>\clpadt45\clpadft3</xsl:text>
					<xsl:text>\clpadr45\clpadfr3</xsl:text>
					<xsl:value-of select="if ($altova:nColumnWidthTw_19_0 = $altova:nDefaultColumnWidthTw_19) then '\clftsWidth1' else ()"/>
					<xsl:text>\cellx</xsl:text>
					<xsl:variable name="altova:CurrGridPos_19" select="$altova:CurrGridPos_19 + $altova:nColumnWidthTw_19_0"/>
					<xsl:value-of select="ceiling($altova:CurrGridPos_19)"/>
					<xsl:text/>
					<xsl:text>\clvertalc</xsl:text>
					<xsl:text>\clpadl45\clpadfl3</xsl:text>
					<xsl:text>\clpadb45\clpadfb3</xsl:text>
					<xsl:text>\clpadt45\clpadft3</xsl:text>
					<xsl:text>\clpadr45\clpadfr3</xsl:text>
					<xsl:value-of select="if ($altova:nColumnWidthTw_19_1 = $altova:nDefaultColumnWidthTw_19) then '\clftsWidth1' else ()"/>
					<xsl:text>\cellx</xsl:text>
					<xsl:variable name="altova:CurrGridPos_19" select="$altova:CurrGridPos_19 + $altova:nColumnWidthTw_19_1"/>
					<xsl:value-of select="ceiling($altova:CurrGridPos_19)"/>
				</xsl:variable>
				<xsl:if test="$templatetablelevel + 1 = 1">
					<xsl:copy-of select="$tablestyle19"/>
					<xsl:copy-of select="$altova:RowStyle"/>
				</xsl:if>
				<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
					<altova:text-block>
	...
	<xsl:template match="altova:CellPadding" mode="altova:rtf">
		<xsl:choose>
			<xsl:when test="string-length(@altova:sValue) gt 0">
				<xsl:variable name="nLengthPt" select="altova:MapLengthUnitToPointsUnrounded_AbsentOk(@altova:sValue)" as="xs:double"/>
				<xsl:variable name="nLengthTw" select="altova:MapPointsToTwips($nLengthPt)" as="xs:integer"/>
				<xsl:value-of select="$nLengthTw"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:choose>
					<xsl:when test="string-length(@altova:sDefault) gt 0">
						<xsl:variable name="nLengthPt" select="altova:MapLengthUnitToPointsUnrounded_AbsentOk(@altova:sDefault)" as="xs:double"/>
						<xsl:variable name="nLengthTw" select="altova:MapPointsToTwips($nLengthPt)" as="xs:integer"/>
						<xsl:value-of select="$nLengthTw"/>
					</xsl:when>
					<xsl:otherwise>
		...
		<xsl:choose>
			...
			<xsl:when test="$altova:bEmbedImages = true() and $sImageType">
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<xsl:value-of select="unparsed-text(@altova:SrcUrl, 'binarytobase16')"/>
					</xsl:otherwise>
				</xsl:choose>
				<xsl:text>}}</xsl:text>
			</xsl:when>
	...
	<xsl:template match="altova:line" mode="altova:rtf">
		<!-- <xsl:value-of select="concat('\par\pard\itap', count(ancestor::altova:table))"></xsl:value-of> -->
	...
	<xsl:template match="altova:list-item" mode="altova:rtf">
		...
		<xsl:text>}</xsl:text>
		<!--
		As a list item is a block level element, generate a line break, but there are exceptions: If the list's (not the
		list item's) parent is e.g. a list item, and the lower list item is the last element in the higher list item,
		don't generate a line break.
		-->
		<xsl:if test="(following-sibling::*[1] and name(following-sibling::*[1]) ne 'altova:new-line') or
			(../following-sibling::*[1] and name(../following-sibling::*[1]) ne 'altova:new-line') or
			not(index-of(('altova:paragraph', 'altova:list-item', 'altova:table-cell'), name(../..)))">
			<xsl:variable name="nDepth" as="xs:integer" select="count(ancestor::altova:table)"/>
			<xsl:text>\par\pard</xsl:text>
			<xsl:if test="$nDepth &gt; 0">
				<xsl:text>\intbl</xsl:text>
	...
	<xsl:template match="altova:NestedTablePropertiesBegin" mode="altova:rtf">
		<!-- table[1] is the table that contains altova:NestedTablePropertiesBegin; if table[2] exists, we're in a nested table -->
		<xsl:if test="ancestor::altova:table[2]">
	...
	<xsl:template match="altova:PageRef" mode="altova:rtf">
		...
		<xsl:if test="$altova:SourceDocument/@altova:Url eq $altova:TargetDocument/@altova:Url">
			<xsl:text>{\field{\*\fldinst{ PAGEREF "</xsl:text>
			<xsl:value-of select="@bookmark-id"/>
			<xsl:text>" \\h}}{\fldrslt }}</xsl:text>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="altova:table-cell" mode="altova:rtf">
		...
		<!-- Character styles -->
		<xsl:variable name="altova:bCharacterStylesPresent" select="@altova:character-styles or @color or @font-family"/>
	...
	<xsl:function name="altova:GenerateRtfTextDecoration" as="xs:string">
		...
		<xsl:value-of select="if ($sTextDecoration != '') then altova:MapTextDecorationToControlWord($sTextDecoration) else ()"/>
	</xsl:function>
