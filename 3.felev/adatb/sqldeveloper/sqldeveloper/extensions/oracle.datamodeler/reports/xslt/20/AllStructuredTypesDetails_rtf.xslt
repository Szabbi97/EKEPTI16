...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_a_st" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:call-template name="altova:Section_0985D400_FooterLeft"/>
			<xsl:text>}</xsl:text>
			<xsl:text>{</xsl:text>
			<xsl:text>\footerr </xsl:text>
			<xsl:call-template name="altova:Section_0985D400_FooterRight"/>
			<xsl:text>}</xsl:text>
			...
			<altova:paragraph altova:selector="center" altova:character-styles="\f0\fs24" altova:paragraph-styles="\qc" altova:is-div="true">
				<altova:text-block altova:character-styles="\fs26\b" altova:character-reset-styles="\fs24\b0">
					<xsl:text>\u65?\u108?\u108?\u32?\u83?\u116?\u114?\u117?\u99?\u116?\u117?\u114?\u101?\u100?\u32?\u84?\u121?\u112?\u101?\u115?\u32?\u68?\u101?\u116?\u97?\u105?\u108?\u115?</xsl:text>
				</altova:text-block>
			</altova:paragraph>
			<altova:new-line/>
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:root">
					<altova:new-line/>
					<altova:new-line/>
					<xsl:variable name="altova:CurrContextGrid_08441C30" select="."/>
					...
					<xsl:for-each select="n1:STCollection">
						<xsl:for-each select="n1:STDetails">
							...
							<xsl:text>{</xsl:text>
							<xsl:text>\footerl </xsl:text>
							<xsl:call-template name="altova:Section_0850FAC8_FooterLeft"/>
							<xsl:text>}</xsl:text>
							<xsl:text>{</xsl:text>
							<xsl:text>\footerr </xsl:text>
							<xsl:call-template name="altova:Section_0850FAC8_FooterRight"/>
							<xsl:text>}</xsl:text>
							<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="56" altova:MarginRightPt="56"/>
							<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
							<xsl:variable name="altova:CurrContextGrid_0F3880F0" select="."/>
							<xsl:variable name="altova:ColumnData">
								<altova:Internal/>
							</xsl:variable>
							<altova:table>
							...
							<xsl:if test="count( n1:DescriptionNotes )">
								...
								<xsl:for-each select="n1:DescriptionNotes">
									<xsl:variable name="altova:CurrContextGrid_086A7960" select="."/>
									<xsl:variable name="altova:ColumnData">
										<altova:Internal/>
									</xsl:variable>
									<altova:table>
							...
							<xsl:if test="count( n1:AttributesCollection)">
								...
								<xsl:variable name="altova:CurrContextGrid_094450B8" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_3" select="round(14176.23)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_3_0" select="round(0.39 * 1440 * $altova:TableWidthFactor_3)"/>
									<xsl:variable name="altova:nColumnWidthTw_3_1" select="round(5.91 * 1440 * $altova:TableWidthFactor_3)"/>
									<xsl:variable name="altova:nColumnWidthTw_3_2" select="round(0.39 * 1440 * $altova:TableWidthFactor_3)"/>
									<xsl:variable name="altova:nColumnWidthTw_3_3" select="round(1.57 * 1440 * $altova:TableWidthFactor_3)"/>
									<xsl:variable name="altova:nColumnWidthTw_3_4" select="round(0.39 * 1440 * $altova:TableWidthFactor_3)"/>
									<xsl:variable name="altova:nColumnWidthTw_3_5" select="round(1.18 * 1440 * $altova:TableWidthFactor_3)"/>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_3_2 = $altova:nDefaultColumnWidthTw_3) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_3" select="$altova:CurrGridPos_3 + $altova:nColumnWidthTw_3_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_3)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_3_3 = $altova:nDefaultColumnWidthTw_3) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_3" select="$altova:CurrGridPos_3 + $altova:nColumnWidthTw_3_3"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_3)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_3_4 = $altova:nDefaultColumnWidthTw_3) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_3" select="$altova:CurrGridPos_3 + $altova:nColumnWidthTw_3_4"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_3)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_3_5 = $altova:nDefaultColumnWidthTw_3) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_3" select="$altova:CurrGridPos_3 + $altova:nColumnWidthTw_3_5"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_3)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
													...
													<xsl:choose>
														<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
															<xsl:for-each select="n1:DataType">
																<altova:text-block>
																	<xsl:apply-templates>
																		<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_3_3 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
																	</xsl:apply-templates>
																</altova:text-block>
															</xsl:for-each>
														</xsl:when>
													...
													<xsl:choose>
														<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
															<xsl:for-each select="n1:DataTypeKind">
																<altova:text-block>
																	<xsl:apply-templates>
																		<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_3_4 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
																	</xsl:apply-templates>
																</altova:text-block>
															</xsl:for-each>
														</xsl:when>
													...
													<xsl:choose>
														<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
															<xsl:for-each select="n1:DomainName">
																<altova:text-block>
																	<xsl:apply-templates>
																		<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_3_5 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
																	</xsl:apply-templates>
																</altova:text-block>
															</xsl:for-each>
														</xsl:when>
							...
							<xsl:if test="count( n1:AttributesCommentsCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_0F447E28" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(14175.23)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_4_1" select="round(2.36 * 1440 * $altova:TableWidthFactor_4)"/>
									<xsl:variable name="altova:nColumnWidthTw_4_2" select="round(3.54 * 1440 * $altova:TableWidthFactor_4)"/>
									<xsl:variable name="altova:nColumnWidthTw_4_3" select="round(3.54 * 1440 * $altova:TableWidthFactor_4)"/>
							...
							<xsl:if test="count( n1:MethodsCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_094866C8" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_5" select="round(14176.73)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_5_2" select="round(0.39 * 1440 * $altova:TableWidthFactor_5)"/>
									<xsl:variable name="altova:nColumnWidthTw_5_3" select="round(0.39 * 1440 * $altova:TableWidthFactor_5)"/>
									<xsl:variable name="altova:nColumnWidthTw_5_4" select="round(1.97 * 1440 * $altova:TableWidthFactor_5)"/>
									<xsl:variable name="altova:nColumnWidthTw_5_5" select="round(1.97 * 1440 * $altova:TableWidthFactor_5)"/>
									<xsl:variable name="altova:nColumnWidthTw_5_6" select="round(2.76 * 1440 * $altova:TableWidthFactor_5)"/>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_5_4 = $altova:nDefaultColumnWidthTw_5) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_5" select="$altova:CurrGridPos_5 + $altova:nColumnWidthTw_5_4"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_5)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_5_5 = $altova:nDefaultColumnWidthTw_5) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_5" select="$altova:CurrGridPos_5 + $altova:nColumnWidthTw_5_5"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_5)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_5_6 = $altova:nDefaultColumnWidthTw_5) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_5" select="$altova:CurrGridPos_5 + $altova:nColumnWidthTw_5_6"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_5)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
												...
												<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
													<xsl:choose>
														<xsl:when test="count(n1:MethodParametersCollection )">
															<altova:new-line/>
															<xsl:variable name="altova:CurrContextGrid_0F859528" select="."/>
															<xsl:variable name="altova:ColumnData">
																<altova:Internal/>
															</xsl:variable>
															<altova:table>
																<xsl:variable name="altova:nTableWidthIn_6" select="$altova:nColumnWidthTw_5_6 div 1440 * 1.00000 - 0.02000 - 0.03125 - 0.03125"/>
																...
																<xsl:variable name="altova:nSumColumnWidthsTw_6" select="round(3742.73)"/>
																...
																<xsl:variable name="altova:nColumnWidthTw_6_0" select="round(1.30 * 1440 * $altova:TableWidthFactor_6)"/>
																<xsl:variable name="altova:nColumnWidthTw_6_1" select="round(1.30 * 1440 * $altova:TableWidthFactor_6)"/>
							...
							<xsl:if test="count( n1:TablesCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_0F5BC2E0" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<xsl:variable name="altova:nColumnWidthTw_7_1" select="round(3.35 * 1440 * $altova:TableWidthFactor_7)"/>
									<xsl:variable name="altova:nColumnWidthTw_7_2" select="round(3.35 * 1440 * $altova:TableWidthFactor_7)"/>
							...
							<xsl:if test="count( n1:EntitiesCollection)">
								...
								<xsl:variable name="altova:CurrContextGrid_0F599768" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<xsl:variable name="altova:nColumnWidthTw_8_0" select="round(4.92 * 1440 * $altova:TableWidthFactor_8)"/>
									<xsl:variable name="altova:nColumnWidthTw_8_1" select="round(4.92 * 1440 * $altova:TableWidthFactor_8)"/>
	...
	<xsl:template name="altova:Section_0850FAC8_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_08362778" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_0850FAC8_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_08362778" select="."/>
		<xsl:variable name="altova:ColumnData">
	...
	<xsl:template name="altova:Section_0985D400_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0809BE18" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_0985D400_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0809BE18" select="."/>
		<xsl:variable name="altova:ColumnData">
		...
		<altova:table>
			...
			<xsl:variable name="altova:nSumColumnWidthsTw_12" select="round(14174.23)"/>
			...
			<xsl:variable name="altova:nColumnWidthTw_12_0" select="round(7.09 * 1440 * $altova:TableWidthFactor_12)"/>
			<xsl:variable name="altova:nColumnWidthTw_12_1" select="round(2.76 * 1440 * $altova:TableWidthFactor_12)"/>
