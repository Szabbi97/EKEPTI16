...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_e" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:call-template name="altova:Section_0D114450_FooterLeft"/>
			<xsl:text>}</xsl:text>
			<xsl:text>{</xsl:text>
			<xsl:text>\footerr </xsl:text>
			<xsl:call-template name="altova:Section_0D114450_FooterRight"/>
			<xsl:text>}</xsl:text>
			...
			<altova:paragraph altova:selector="center" altova:character-styles="\f0\fs24" altova:paragraph-styles="\qc" altova:is-div="true">
				<altova:text-block altova:character-styles="\fs26\b" altova:character-reset-styles="\fs24\b0">
					<xsl:text>\u69?\u110?\u116?\u105?\u116?\u121?\u32?\u68?\u101?\u116?\u97?\u105?\u108?\u115?</xsl:text>
				</altova:text-block>
			</altova:paragraph>
			<altova:new-line/>
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:root">
					<altova:new-line/>
					<altova:new-line/>
					<xsl:variable name="altova:CurrContextGrid_0AF89930" select="."/>
					...
					<xsl:variable name="altova:CurrContextGrid_0E75CBD0" select="."/>
					<xsl:variable name="altova:ColumnData">
						<altova:Internal/>
					</xsl:variable>
					<altova:table>
						...
						<altova:table-row>
							...
							<altova:table-cell altova:paragraph-styles="\sl0">
								<xsl:variable name="altova:CurrContextGrid_09421B50" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
							...
							<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
								<xsl:if test="count( n1:MappedTablesCollection )">
									...
									<altova:new-line/>
									<xsl:variable name="altova:CurrContextGrid_092CD6D0" select="."/>
									<xsl:variable name="altova:ColumnData">
										<altova:Internal/>
									</xsl:variable>
									<altova:table>
					...
					<xsl:if test="count( n1:DescriptionNotes )">
						...
						<xsl:for-each select="n1:DescriptionNotes">
							<xsl:variable name="altova:CurrContextGrid_06B7C708" select="."/>
							<xsl:variable name="altova:ColumnData">
								<altova:Internal/>
							</xsl:variable>
							<altova:table>
					...
					<xsl:if test="count( n1:QuantitativeInfoCollection )">
						...
						<xsl:for-each select="n1:QuantitativeInfoCollection">
							<xsl:variable name="altova:CurrContextGrid_094482F0" select="."/>
							<xsl:variable name="altova:ColumnData">
								<altova:Internal/>
							</xsl:variable>
							<altova:table>
					...
					<xsl:if test="count( n1:AttributesCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_0F51E140" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:AttributesCommentsCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_0AF87518" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:ConstraintsCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_093C61A0" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
									...
									<altova:table-row>
										...
										<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
											<xsl:if test="count( n1:RangesCollection ) != 0">
												<xsl:variable name="altova:CurrContextGrid_06B69908" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
												<altova:table>
											...
											<xsl:if test="count( n1:ValueListsCollection ) != 0">
												<xsl:variable name="altova:CurrContextGrid_0C8D3598" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
												<altova:table>
											...
											<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
												<xsl:variable name="altova:CurrContextGrid_08651F90" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
												<altova:table>
					...
					<xsl:if test="count( n1:IdentifiersCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_0D104230" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:RelationshipsCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_08427C70" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:IncomingProcessesCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_0926AE78" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:OutgoingProcessesCollection ) !=0">
						...
						<xsl:variable name="altova:CurrContextGrid_0DAE6D48" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
	...
	<xsl:template name="altova:Section_0D114450_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0A2EE780" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_0D114450_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0A2EE780" select="."/>
		<xsl:variable name="altova:ColumnData">
