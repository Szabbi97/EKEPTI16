...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_at" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:call-template name="altova:Section_092D78A0_FooterLeft"/>
			<xsl:text>}</xsl:text>
			<xsl:text>{</xsl:text>
			<xsl:text>\footerr </xsl:text>
			<xsl:call-template name="altova:Section_092D78A0_FooterRight"/>
			<xsl:text>}</xsl:text>
			...
			<altova:paragraph altova:selector="center" altova:character-styles="\f0\fs24" altova:paragraph-styles="\qc" altova:is-div="true">
				<altova:text-block altova:character-styles="\fs26\b" altova:character-reset-styles="\fs24\b0">
					<xsl:text>\u65?\u108?\u108?\u32?\u84?\u97?\u98?\u108?\u101?\u115?\u32?\u68?\u101?\u116?\u97?\u105?\u108?\u115?</xsl:text>
				</altova:text-block>
			</altova:paragraph>
			<altova:new-line/>
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:root">
					<altova:new-line/>
					<altova:new-line/>
					<xsl:variable name="altova:CurrContextGrid_08093C48" select="."/>
					...
					<xsl:for-each select="n1:TablesCollection">
						<xsl:for-each select="n1:TableDetails">
							...
							<xsl:text>{</xsl:text>
							<xsl:text>\footerl </xsl:text>
							<xsl:call-template name="altova:Section_0AF93C68_FooterLeft"/>
							<xsl:text>}</xsl:text>
							<xsl:text>{</xsl:text>
							<xsl:text>\footerr </xsl:text>
							<xsl:call-template name="altova:Section_0AF93C68_FooterRight"/>
							<xsl:text>}</xsl:text>
							<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="56" altova:MarginRightPt="56"/>
							<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
							<xsl:variable name="altova:CurrContextGrid_08093BE8" select="."/>
							<xsl:variable name="altova:ColumnData">
								<altova:Internal/>
							</xsl:variable>
							<altova:table>
							...
							<xsl:if test="count( n1:DescriptionNotes )">
								...
								<xsl:for-each select="n1:DescriptionNotes">
									<xsl:variable name="altova:CurrContextGrid_082C0F50" select="."/>
									<xsl:variable name="altova:ColumnData">
										<altova:Internal/>
									</xsl:variable>
									<altova:table>
							...
							<xsl:if test="count( n1:QuantitativeInfoCollection )">
								...
								<xsl:for-each select="n1:QuantitativeInfoCollection">
									<xsl:variable name="altova:CurrContextGrid_0939A9E8" select="."/>
									<xsl:variable name="altova:ColumnData">
										<altova:Internal/>
									</xsl:variable>
									<altova:table>
										...
										<altova:table-row>
											<xsl:variable name="altova:RowStyle">
												...
												<xsl:text>\clpadt45\clpadft3</xsl:text>
												<xsl:text>\clpadr45\clpadfr3</xsl:text>
												<xsl:value-of select="if ($altova:nColumnWidthTw_3_1 = $altova:nDefaultColumnWidthTw_3) then '\clftsWidth1' else ()"/>
												<xsl:text>\cellx</xsl:text>
												<xsl:variable name="altova:CurrGridPos_3" select="$altova:CurrGridPos_3 + $altova:nColumnWidthTw_3_1"/>
												<xsl:value-of select="ceiling($altova:CurrGridPos_3)"/>
											</xsl:variable>
											<xsl:if test="$templatetablelevel + 1 = 1">
							...
							<xsl:if test="count( n1:ColumnsCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_0A26E338" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_4_2 = $altova:nDefaultColumnWidthTw_4) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_4" select="$altova:CurrGridPos_4 + $altova:nColumnWidthTw_4_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_4)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_4_3 = $altova:nDefaultColumnWidthTw_4) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_4" select="$altova:CurrGridPos_4 + $altova:nColumnWidthTw_4_3"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_4)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_4_4 = $altova:nDefaultColumnWidthTw_4) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_4" select="$altova:CurrGridPos_4 + $altova:nColumnWidthTw_4_4"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_4)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_4_5 = $altova:nDefaultColumnWidthTw_4) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_4" select="$altova:CurrGridPos_4 + $altova:nColumnWidthTw_4_5"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_4)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_4_6 = $altova:nDefaultColumnWidthTw_4) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_4" select="$altova:CurrGridPos_4 + $altova:nColumnWidthTw_4_6"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_4)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_4_7 = $altova:nDefaultColumnWidthTw_4) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_4" select="$altova:CurrGridPos_4 + $altova:nColumnWidthTw_4_7"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_4)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_4_8 = $altova:nDefaultColumnWidthTw_4) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_4" select="$altova:CurrGridPos_4 + $altova:nColumnWidthTw_4_8"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_4)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_4_9 = $altova:nDefaultColumnWidthTw_4) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_4" select="$altova:CurrGridPos_4 + $altova:nColumnWidthTw_4_9"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_4)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_4_10 = $altova:nDefaultColumnWidthTw_4) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_4" select="$altova:CurrGridPos_4 + $altova:nColumnWidthTw_4_10"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_4)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
							...
							<xsl:if test="count( n1:ColumnsCommentsCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_06B8C4C8" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_5_2 = $altova:nDefaultColumnWidthTw_5) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_5" select="$altova:CurrGridPos_5 + $altova:nColumnWidthTw_5_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_5)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_5_3 = $altova:nDefaultColumnWidthTw_5) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_5" select="$altova:CurrGridPos_5 + $altova:nColumnWidthTw_5_3"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_5)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
							...
							<xsl:if test="count( n1:IndexesCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_08C21168" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
							...
							<xsl:if test="count( n1:ConstraintsCollection )">
								...
								<altova:new-line/>
								<xsl:variable name="altova:CurrContextGrid_07FCAD88" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<xsl:variable name="altova:table">
									<altova:table altova:hide-rows="body-empty">
													...
													<altova:table-row>
														...
														<altova:table-cell altova:is-body-cell="true" altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
															<xsl:if test="count( n1:RangesCollection ) != 0">
																<xsl:variable name="altova:CurrContextGrid_083EE738" select="."/>
																<xsl:variable name="altova:ColumnData">
																	<altova:Internal/>
																</xsl:variable>
																<altova:table>
															...
															<xsl:if test="count( n1:ValueListsCollection ) != 0">
																<altova:new-line/>
																<xsl:variable name="altova:CurrContextGrid_0DA87250" select="."/>
																<xsl:variable name="altova:ColumnData">
																	<altova:Internal/>
																</xsl:variable>
																<altova:table>
															...
															<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
																<altova:new-line/>
																<xsl:variable name="altova:CurrContextGrid_0962DDD8" select="."/>
																<xsl:variable name="altova:ColumnData">
																	<altova:Internal/>
																</xsl:variable>
																<altova:table>
							...
							<xsl:if test="count( n1:FKRTCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_07FC7610" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
									...
									<altova:table-row>
										<xsl:variable name="altova:RowStyle">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_11_2 = $altova:nDefaultColumnWidthTw_11) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_11" select="$altova:CurrGridPos_11 + $altova:nColumnWidthTw_11_2"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_11)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_11_3 = $altova:nDefaultColumnWidthTw_11) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_11" select="$altova:CurrGridPos_11 + $altova:nColumnWidthTw_11_3"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_11)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_11_4 = $altova:nDefaultColumnWidthTw_11) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_11" select="$altova:CurrGridPos_11 + $altova:nColumnWidthTw_11_4"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_11)"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_11_5 = $altova:nDefaultColumnWidthTw_11) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_11" select="$altova:CurrGridPos_11 + $altova:nColumnWidthTw_11_5"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_11)"/>
										</xsl:variable>
										<xsl:if test="$templatetablelevel + 1 = 1">
							...
							<xsl:if test="count( n1:FKRFCollection )">
								...
								<xsl:variable name="altova:CurrContextGrid_0841D898" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
	...
	<xsl:template name="altova:Section_092D78A0_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_082B5938" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_092D78A0_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_082B5938" select="."/>
		<xsl:variable name="altova:ColumnData">
	...
	<xsl:template name="altova:Section_0AF93C68_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0A21AB88" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_0AF93C68_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0A21AB88" select="."/>
		<xsl:variable name="altova:ColumnData">
	...
	<xsl:function name="altova:is-cell-empty" as="xs:boolean">
		...
		<xsl:sequence select="not( boolean( $altova:cell/child::node() ) )"/>
	</xsl:function>
