...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_g" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:call-template name="altova:Section_09121448_FooterLeft"/>
			<xsl:text>}</xsl:text>
			<xsl:text>{</xsl:text>
			<xsl:text>\footerr </xsl:text>
			<xsl:call-template name="altova:Section_09121448_FooterRight"/>
			<xsl:text>}</xsl:text>
			...
			<altova:paragraph altova:selector="center" altova:character-styles="\f0\fs24" altova:paragraph-styles="\qc" altova:is-div="true">
				<altova:text-block altova:character-styles="\fs26\b" altova:character-reset-styles="\fs24\b0">
					<xsl:text>\u71?\u108?\u111?\u115?\u115?\u97?\u114?\u121?\u32?\u68?\u101?\u116?\u97?\u105?\u108?\u115?</xsl:text>
				</altova:text-block>
			</altova:paragraph>
			<altova:new-line/>
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:root">
					<altova:new-line/>
					<xsl:variable name="altova:CurrContextGrid_09129900" select="."/>
					...
					<xsl:variable name="altova:CurrContextGrid_094218D0" select="."/>
					<xsl:variable name="altova:ColumnData">
						<altova:Internal/>
					</xsl:variable>
					<altova:table>
						...
						<altova:table-row>
							<xsl:variable name="altova:RowStyle">
								...
								<xsl:text>\clpadt45\clpadft3</xsl:text>
								<xsl:text>\clpadr45\clpadfr3</xsl:text>
								<xsl:value-of select="if ($altova:nColumnWidthTw_1_3 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_3"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
								<xsl:text/>
								<xsl:text>\clvertalc</xsl:text>
								<xsl:element name="altova:TableCellColor">
								...
								<xsl:text>\clpadt45\clpadft3</xsl:text>
								<xsl:text>\clpadr45\clpadfr3</xsl:text>
								<xsl:value-of select="if ($altova:nColumnWidthTw_1_4 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_4"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
								<xsl:text/>
								<xsl:text>\clvertalc</xsl:text>
								<xsl:element name="altova:TableCellColor">
								...
								<xsl:text>\clpadt45\clpadft3</xsl:text>
								<xsl:text>\clpadr45\clpadfr3</xsl:text>
								<xsl:value-of select="if ($altova:nColumnWidthTw_1_5 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_5"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
								<xsl:text/>
								<xsl:text>\clvertalc</xsl:text>
								<xsl:element name="altova:TableCellColor">
								...
								<xsl:text>\clpadt45\clpadft3</xsl:text>
								<xsl:text>\clpadr45\clpadfr3</xsl:text>
								<xsl:value-of select="if ($altova:nColumnWidthTw_1_6 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_6"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
								<xsl:text/>
								<xsl:text>\clvertalc</xsl:text>
								<xsl:element name="altova:TableCellColor">
								...
								<xsl:text>\clpadt45\clpadft3</xsl:text>
								<xsl:text>\clpadr45\clpadfr3</xsl:text>
								<xsl:value-of select="if ($altova:nColumnWidthTw_1_7 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_7"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
								<xsl:text/>
								<xsl:text>\clvertalc</xsl:text>
								<xsl:element name="altova:TableCellColor">
								...
								<xsl:text>\clpadt45\clpadft3</xsl:text>
								<xsl:text>\clpadr45\clpadfr3</xsl:text>
								<xsl:value-of select="if ($altova:nColumnWidthTw_1_8 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_8"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
							</xsl:variable>
							<xsl:if test="$templatetablelevel + 1 = 1">
	...
	<xsl:template name="altova:Section_09121448_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0914E3C0" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_09121448_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0914E3C0" select="."/>
		<xsl:variable name="altova:ColumnData">
