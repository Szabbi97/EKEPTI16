...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_s_st" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:call-template name="altova:Section_06B178B8_FooterLeft"/>
			<xsl:text>}</xsl:text>
			<xsl:text>{</xsl:text>
			<xsl:text>\footerr </xsl:text>
			<xsl:call-template name="altova:Section_06B178B8_FooterRight"/>
			<xsl:text>}</xsl:text>
			...
			<altova:paragraph altova:selector="center" altova:character-styles="\f0\fs24" altova:paragraph-styles="\qc" altova:is-div="true">
				<altova:text-block altova:character-styles="\fs26\b" altova:character-reset-styles="\fs24\b0">
					<xsl:text>\u83?\u116?\u114?\u117?\u99?\u116?\u117?\u114?\u101?\u100?\u32?\u84?\u121?\u112?\u101?\u32?\u68?\u101?\u116?\u97?\u105?\u108?\u115?</xsl:text>
				</altova:text-block>
			</altova:paragraph>
			<altova:new-line/>
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:root">
					<altova:new-line/>
					<altova:new-line/>
					<xsl:variable name="altova:CurrContextGrid_0832D3C0" select="."/>
					...
					<xsl:variable name="altova:CurrContextGrid_08399A30" select="."/>
					<xsl:variable name="altova:ColumnData">
						<altova:Internal/>
					</xsl:variable>
					<altova:table>
					...
					<xsl:if test="count( n1:DescriptionNotes )">
						...
						<xsl:for-each select="n1:DescriptionNotes">
							<xsl:variable name="altova:CurrContextGrid_0F42A090" select="."/>
							<xsl:variable name="altova:ColumnData">
								<altova:Internal/>
							</xsl:variable>
							<altova:table>
					...
					<xsl:if test="count( n1:AttributesCollection)">
						...
						<xsl:variable name="altova:CurrContextGrid_0954C7C8" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:AttributesCommentsCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_0A30BE98" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:MethodsCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_0C5B9120" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
										...
										<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
											<xsl:choose>
												<xsl:when test="count(n1:MethodParametersCollection )">
													<altova:new-line/>
													<xsl:variable name="altova:CurrContextGrid_0F860118" select="."/>
													<xsl:variable name="altova:ColumnData">
														<altova:Internal/>
													</xsl:variable>
													<altova:table>
					...
					<xsl:if test="count( n1:TablesCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_0F447250" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:EntitiesCollection)">
						...
						<xsl:variable name="altova:CurrContextGrid_06B8ACE8" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
	...
	<xsl:template name="altova:Section_06B178B8_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0980FC48" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_06B178B8_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_0980FC48" select="."/>
		<xsl:variable name="altova:ColumnData">
