...
EXECUTE dbms_output.put_line('Start repository upgrade from 11.2.0.1.10 to 11.2.0.1.11.');
EXECUTE dbms_output.put_line('');
...
EXECUTE dbms_output.put_line('');
EXECUTE dbms_output.put_line('End repository upgrade from 11.2.0.1.10 to 11.2.0.1.11.');
EXECUTE dbms_output.put_line('');
