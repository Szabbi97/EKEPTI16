...
namespace _06_Helyettes
{
    class Program
    {
        ...
        static User Deputy(User user)
        {
            ...
            {
                return Deputy(users.Where(u => u.Id == user.DeputyId).First());
                //return Deputy(GetUserById(user.DeputyId));
            }
        }
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("{0} levelét a(z) {1} címre kell küldeni.", ede.Name,deputy.Email);
            Console.ReadKey();
        }
    }
}
